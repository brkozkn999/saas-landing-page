    ...
    <div className="bg-black text-white bg-[linear-gradient(to_bottom,#000,#200D42_34%,#4F21A1_65%,#A46EDB_82%)] py-[72px] sm:py-24 relative overflow-clip">
      ...
      <div className="container relative">
        <div className="flex items-center justify-center">
          <a href="#" className="inline-flex gap-3 border py-1 px-2 rounded-lg bg-white/30">
        ...
        <div className="flex justify-center mt-8">
          <div className="inline-flex relative">
            ...
            <motion.div className="absolute right-[476px] top-[108px] hidden sm:inline"
              ...
              <Image src={cursorImage} height={200} width={200} alt="" className="max-w-none" quality={100} draggable={false} />
            </motion.div>

            <motion.div className="absolute top-[56px] left-[498px] hidden sm:inline"
              drag dragSnapToOrigin>
              <Image src={messageImage} height={200} width={200} alt="" className="max-w-none" quality={100} draggable={false} />
            </motion.div>
          </div>
        </div>
